...
This is the video’s brief, written as a prompt you can hand to your agent (we validate every prompt we publish against a clean project and the [remocn skill](/docs/getting-started/agent-skill)):
